...
public final class TdApi {
    ...
    public func clickAnimatedEmojiMessage(
        chatId: Int64,
        messageId: Int64,
        completion: @escaping (Result<Sticker, Swift.Error>) -> Void) throws {
    ...
    public func getInternalLinkType(
        link: String,
        completion: @escaping (Result<InternalLinkType, Swift.Error>) -> Void) throws {
    ...
    public func getCommands(
        languageCode: String,
        scope: BotCommandScope,
        completion: @escaping (Result<BotCommands, Swift.Error>) -> Void) throws {
    ...
    public func checkStickerSetName(
        name: String,
        completion: @escaping (Result<CheckStickerSetNameResult, Swift.Error>) -> Void) throws {
