...
public class TDLibApi {
    ...
    public final func getActiveLiveLocationMessages(completion: @escaping (Result<Messages, Swift.Error>) -> Void) throws {
    ...
    /// - Returns: All active live locations that need to be updated by the application
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    public final func getActiveLiveLocationMessages() async throws -> Messages {
        let query = GetActiveLiveLocationMessages()
        return try await self.run(query: query)
    }
    ...
    public final func shareUserWithBot(
        buttonId: Int?,
        chatId: Int64?,
        messageId: Int64?,
        onlyCheck: Bool?,
    ...
    public final func readAllMessageThreadMentions(
        chatId: Int64?,
        messageThreadId: Int64?,
        completion: @escaping (Result<Ok, Swift.Error>) -> Void
    ) throws {
    ...
    public final func readAllMessageThreadReactions(
        chatId: Int64?,
        messageThreadId: Int64?,
        completion: @escaping (Result<Ok, Swift.Error>) -> Void
    ) throws {
    ...
    /// - Returns: The list of pinned stories posted by the given chat. The stories are returned in a reverse chronological order (i.e., in order of decreasing story_id). For optimal performance, the number of returned stories is chosen by TDLib
    public final func getChatPinnedStories(
        chatId: Int64?,
        fromStoryId: Int?,
        limit: Int?,
        completion: @escaping (Result<Stories, Swift.Error>) -> Void
    ) throws {
        let query = GetChatPinnedStories(
            chatId: chatId,
    ...
    public final func getStoryViewers(
        limit: Int?,
    ...
    /// - Parameter groupCallId: Group call identifier
    public final func startScheduledGroupCall(
        groupCallId: Int?,
        completion: @escaping (Result<Ok, Swift.Error>) -> Void
    ) throws {
    ...
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    @discardableResult
    public final func startScheduledGroupCall(groupCallId: Int?) async throws -> Ok {
        let query = StartScheduledGroupCall(
            groupCallId: groupCallId
        )
        return try await self.run(query: query)
    ...
    /// - Parameter groupCallId: Group call identifier
    public final func toggleGroupCallEnabledStartNotification(
    ...
    public final func setGroupCallTitle(
        groupCallId: Int?,
        title: String?,
        completion: @escaping (Result<Ok, Swift.Error>) -> Void
    ) throws {
    ...
    public final func toggleGroupCallMuteNewParticipants(
        groupCallId: Int?,
    ...
    /// - Parameter groupCallId: Group call identifier
    /// - Returns: Invite link to a video chat in a public chat
    public final func getGroupCallInviteLink(
        canSelfUnmute: Bool?,
        groupCallId: Int?,
        completion: @escaping (Result<HttpUrl, Swift.Error>) -> Void
    ) throws {
    ...
    public final func toggleMessageSenderIsBlocked(
        isBlocked: Bool?,
        senderId: MessageSender?,
        completion: @escaping (Result<Ok, Swift.Error>) -> Void
    ) throws {
    ...
    /// - Parameter contacts: The list of contacts to import or edit; contacts' vCard are ignored and are not imported
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    public final func importContacts(contacts: [Contact]?) async throws -> ImportedContacts {
        let query = ImportContacts(
            contacts: contacts
        )
        return try await self.run(query: query)
    ...
    /// - Parameter contacts: The new list of contacts, contact's vCard are ignored and are not imported
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    public final func changeImportedContacts(contacts: [Contact]?) async throws -> ImportedContacts {
        let query = ChangeImportedContacts(
            contacts: contacts
        )
        return try await self.run(query: query)
    ...
    /// - Parameter name: Name of the sticker set
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    public final func searchStickerSet(name: String?) async throws -> StickerSet {
        let query = SearchStickerSet(
            name: name
        )
        return try await self.run(query: query)
    ...
    /// - Parameter query: Query to search for
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    public final func searchStickerSets(query: String?) async throws -> StickerSets {
        let query = SearchStickerSets(
            query: query
        )
        return try await self.run(query: query)
    ...
    public final func getWebPagePreview(
        text: FormattedText?,
    ...
    /// - Returns: A web page preview by the text of the message. Returns a 404 error if the web page has no preview
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    public final func getWebPagePreview(text: FormattedText?) async throws -> WebPage {
        let query = GetWebPagePreview(
            text: text
        )
        return try await self.run(query: query)
    ...
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    @discardableResult
    public final func setLocation(location: Location?) async throws -> Ok {
        let query = SetLocation(
            location: location
        )
        return try await self.run(query: query)
    ...
    public final func changePhoneNumber(
        phoneNumber: String?,
        settings: PhoneNumberAuthenticationSettings?,
    ...
    public final func resendChangePhoneNumberCode(completion: @escaping (Result<AuthenticationCodeInfo, Swift.Error>) -> Void) throws {
    ...
    /// Resends the authentication code sent to confirm a new phone number for the current user. Works only if the previously received authenticationCodeInfo next_code_type was not null and the server-specified timeout has passed
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    public final func resendChangePhoneNumberCode() async throws -> AuthenticationCodeInfo {
        let query = ResendChangePhoneNumberCode()
        return try await self.run(query: query)
    }
    ...
    /// - Parameter code: Authentication code to check
    public final func checkChangePhoneNumberCode(
        code: String?,
        completion: @escaping (Result<Ok, Swift.Error>) -> Void
    ) throws {
    ...
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    @discardableResult
    public final func checkChangePhoneNumberCode(code: String?) async throws -> Ok {
        let query = CheckChangePhoneNumberCode(
            code: code
        )
        return try await self.run(query: query)
    ...
    /// - Returns: Backgrounds installed by the user
    public final func getBackgrounds(
        forDarkTheme: Bool?,
    ...
    /// - Returns: Backgrounds installed by the user
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    public final func getBackgrounds(forDarkTheme: Bool?) async throws -> Backgrounds {
        let query = GetBackgrounds(
            forDarkTheme: forDarkTheme
        )
        return try await self.run(query: query)
    ...
    public final func setBackground(
        background: InputBackground?,
        forDarkTheme: Bool?,
        type: BackgroundType?,
        completion: @escaping (Result<Background, Swift.Error>) -> Void
    ...
    public final func removeBackground(
    ...
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    @discardableResult
    public final func removeBackground(backgroundId: TdInt64?) async throws -> Ok {
        let query = RemoveBackground(
            backgroundId: backgroundId
        )
        return try await self.run(query: query)
    ...
    public final func resetBackgrounds(completion: @escaping (Result<Ok, Swift.Error>) -> Void) throws {
    ...
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    @discardableResult
    public final func resetBackgrounds() async throws -> Ok {
        let query = ResetBackgrounds()
        return try await self.run(query: query)
    }
    ...
    /// - Parameter phoneNumber: The phone number of the user, in international format
    /// - Parameter settings: Settings for the authentication of the user's phone number; pass null to use default settings
    public final func sendPhoneNumberVerificationCode(
        phoneNumber: String?,
        settings: PhoneNumberAuthenticationSettings?,
        completion: @escaping (Result<AuthenticationCodeInfo, Swift.Error>) -> Void
    ) throws {
    ...
    public final func resendPhoneNumberVerificationCode(completion: @escaping (Result<AuthenticationCodeInfo, Swift.Error>) -> Void) throws {
    ...
    /// Resends the code to verify a phone number to be added to a user's Telegram Passport
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    public final func resendPhoneNumberVerificationCode() async throws -> AuthenticationCodeInfo {
        let query = ResendPhoneNumberVerificationCode()
        return try await self.run(query: query)
    }
    ...
    /// - Parameter code: Verification code to check
    public final func checkPhoneNumberVerificationCode(
        code: String?,
        completion: @escaping (Result<Ok, Swift.Error>) -> Void
    ) throws {
    ...
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    @discardableResult
    public final func checkPhoneNumberVerificationCode(code: String?) async throws -> Ok {
        let query = CheckPhoneNumberVerificationCode(
            code: code
        )
        return try await self.run(query: query)
    ...
    /// - Parameter settings: Settings for the authentication of the user's phone number; pass null to use default settings
    public final func sendPhoneNumberConfirmationCode(
        hash: String?,
        phoneNumber: String?,
        settings: PhoneNumberAuthenticationSettings?,
        completion: @escaping (Result<AuthenticationCodeInfo, Swift.Error>) -> Void
    ...
    public final func resendPhoneNumberConfirmationCode(completion: @escaping (Result<AuthenticationCodeInfo, Swift.Error>) -> Void) throws {
    ...
    /// Resends phone number confirmation code
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    public final func resendPhoneNumberConfirmationCode() async throws -> AuthenticationCodeInfo {
        let query = ResendPhoneNumberConfirmationCode()
        return try await self.run(query: query)
    }
    ...
    public final func checkPhoneNumberConfirmationCode(
        code: String?,
        completion: @escaping (Result<Ok, Swift.Error>) -> Void
    ) throws {
    ...
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    @discardableResult
    public final func checkPhoneNumberConfirmationCode(code: String?) async throws -> Ok {
        let query = CheckPhoneNumberConfirmationCode(
            code: code
        )
        return try await self.run(query: query)
    ...
    public final func addApplicationChangelog(
    ...
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    @discardableResult
    public final func addApplicationChangelog(previousApplicationVersion: String?) async throws -> Ok {
        let query = AddApplicationChangelog(
            previousApplicationVersion: previousApplicationVersion
        )
        return try await self.run(query: query)
    ...
    public final func getProxies(completion: @escaping (Result<Proxies, Swift.Error>) -> Void) throws {
    ...
    /// - Returns: List of proxies that are currently set up
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    public final func getProxies() async throws -> Proxies {
        let query = GetProxies()
        return try await self.run(query: query)
    }
    ...
    public final func getProxyLink(
        proxyId: Int?,
        completion: @escaping (Result<HttpUrl, Swift.Error>) -> Void
    ) throws {
    ...
    /// - Returns: An HTTPS link, which can be used to add a proxy
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    public final func getProxyLink(proxyId: Int?) async throws -> HttpUrl {
        let query = GetProxyLink(
            proxyId: proxyId
        )
        return try await self.run(query: query)
    ...
    /// - Parameter proxyId: Proxy identifier. Use 0 to ping a Telegram server without a proxy
    @available(iOS 13.0, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
    public final func pingProxy(proxyId: Int?) async throws -> Seconds {
        let query = PingProxy(
            proxyId: proxyId
        )
        return try await self.run(query: query)
